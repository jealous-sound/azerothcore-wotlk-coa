...
void WorldSession::LogoutPlayer(bool save, bool redirecting)
{
    ...
    if (_player)
    {
        ...
        // mod_playerbots: bots log out per character, not per account
...
// mod_playerbots: the prototype was declared in the header without a definition. Bots feed
// the packets they generate into their own session through this queue.
