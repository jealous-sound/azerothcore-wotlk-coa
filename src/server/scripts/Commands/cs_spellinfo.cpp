...
public:
    ...
    static char const* GetAuraTypeName(uint32 aura)
    {
        switch (aura)
        {
            ...
            case SPELL_AURA_ASCENSION_IGNORE_MIN_RANGE: return "SPELL_AURA_ASCENSION_IGNORE_MIN_RANGE";
            ...
            case SPELL_AURA_ASCENSION_MOD_CRIT_CHANCE: return "SPELL_AURA_ASCENSION_MOD_CRIT_CHANCE";
