...
INSERT INTO `creature_template_model` (`CreatureID`, `Idx`, `CreatureDisplayID`, `DisplayScale`, `Probability`) SELECT 840025, 0, 775, 1, 1 WHERE NOT EXISTS (SELECT 1 FROM `creature_template_model` WHERE `CreatureID` = 840025);
UPDATE `creature_template_model` SET `CreatureDisplayID` = 775 WHERE `CreatureID` = 840025 AND `CreatureDisplayID` = 49;
