...
-- PROC_FLAG_DONE_SPELL_NONE_DMG_CLASS_POS = 0x10000 = 65536 (Spell.cpp:2763-2776, SpellMgr.h). It deals no
-- damage and no healing, so Unit::ProcSkillsAndAuras computes SpellTypeMask PROC_SPELL_TYPE_NO_DMG_HEAL
-- (4). SpellPhaseMask is 2 (PROC_SPELL_PHASE_HIT). HitMask stays 0 for the default normal/critical/absorb
...
(300839, 0, 22, 16, 0, 0, 65536, 4, 2, 0, 0, 0, 0, 100, 0, 0);
